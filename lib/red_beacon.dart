...
Future<void> addRedBeaconModel(MapboxMap mapboxMap) async {     
  ...
  await mapboxMap.style.addSource(
    GeoJsonSource(id: "red-beacon-source", data: json.encode(point)), 
  );

  final modelLayer = ModelLayer(id: "red-beacon-layer", sourceId: "red-beacon-source");
